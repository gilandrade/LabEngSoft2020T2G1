...
def listaPacientes():
    ...
    if request.method == 'POST':
        ...
        if paciente:
            ...
            return render_template('dadosPaciente.html', nomePaciente=paciente.name, pesoPaciente=paciente.weight, idadePaciente=paciente.age, alturaPaciente=paciente.height, medResp=med.name, dadosFitbit=dadosFitbit)
        else:
...
def criarMeta():
    if request.method == 'POST':
        novaMeta = request.form['novaMeta']
        usuarioNovaMeta = request.form['nomePacienteMeta']
        return render_template('criarMeta.html', novaMeta=novaMeta, usuarioNovaMeta=usuarioNovaMeta)
    return render_template('criarMeta.html')

@app.route('/criarExercicio', methods=['GET', 'POST'])
def criarExercicio():
    if request.method == 'POST':
        pacienteExercicio = request.form['nomePacienteExercicio']
        tituloExercicio = request.form['tituloExercicio']
        descricaoExercicio = request.form['descricaoExercicio']
        linkExercicio = request.form['linkExercicio']
        return render_template('criarExercicio.html',pacienteExercicio=pacienteExercicio, tituloExercicio=tituloExercicio, descricaoExercicio=descricaoExercicio, linkExercicio=linkExercicio )
